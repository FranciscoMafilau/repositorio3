...
package ejerciciovectorescomoatributos;

import entidades.CursoEntidades;



public class EjercicioVectoresComoAtributos {
...
*/
    public static void main(String[] args) {
     CursoEntidades n1 = new CursoEntidades();
        n1.crearCurso();
        System.out.println("El total de ganacia semanal es: " + n1.calcularGananciaSemanal(n1));
    }
