...
La letra correspondiente al dígito verificador se calculará a traves de un método que funciona de la siguiente manera: Para 
calcular la letra se toma el resto de dividir el número de DNI por 23 (el resultado debe ser un número entre 0 y 22). El método 
...
char aux = Vector[DNI%23];

NIF nif1 = new NIF(DNI, aux);
    return nif1;

}

public void mostrarNif(NIF n){
    System.out.println("00"+ n.getDNI() + " -" + n.getLetra());
}
}
